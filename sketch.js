...
redCG = new Group();
  ...
  mainCyclist.setCollider("circle",0,0,480);
...
function draw() {
  ...
  if(gameState===PLAY){
   ...
   path.velocityX = -(7 + 3*distance/250);
  ...
  textSize(20);
  fill(255);
  text("Press Up Arrow To Restart the Game!",475,310);
...
function reset(){
 ...
 pinkCG.destroyEach(-2);
  redCG.destroyEach(-2);
  yellowCG.destroyEach(-2);
